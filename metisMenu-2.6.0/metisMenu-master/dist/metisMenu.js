    ...
    var MetisMenu = function () {
      ...
      _createClass(MetisMenu, [{
        ...
        value: function init() {
          ...
          $(this._element).children('li').children('a:only-child').on(Event.CLICK_DATA_API, function (e) {
            var _this = $(this);
            var _parent = _this.parent('li');
            var _siblings = _parent.siblings('li').children('a');
            var _list = _parent.children('ul');
            ...
            // _parent.siblings('li').has('ul').map(function(i, v){
              
            //   self._hide($(v).children('ul'));
            // })
            _parent.siblings().children('ul.' + 'in').siblings('a').attr('aria-expanded', false);
            self._hide(_parent.siblings().children('ul.' + 'in').attr('aria-expanded', false));
